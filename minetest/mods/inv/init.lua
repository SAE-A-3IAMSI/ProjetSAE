...
-- Fonction pour vérifier si un objet n'est pas empilable
...
-- Fonction pour ajouter les objets d'un inventaire à une liste
...
-- Commande pour enregistrer l'inventaire de tous les joueurs connectés
...
-- Commande pour enregistrer l'inventaire d'un joueur
...
-- Commande pour enregistrer l'inventaire de l'expéditeur
...
-- Hook pour gérer lorsqu'un joueur largue un item
...
-- Commande pour voir l'inventaire d'un joueur
...
-- Commande pour voir l'inventaire de craft d'un joueur
